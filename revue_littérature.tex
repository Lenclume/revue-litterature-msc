...
\input{feng_situ_2021}
\input{luinaud_bridging_2020}

% Thèses ''Trois mousquetaires''
\input{santiago_da_silva_fully_2020}
\input{luinaud_algorithmes_2017}
\input{stimpfling_memoires_2020}

% Soumission P4 Workshop 2023
\input{elbediwy_dr-pifo_nodate}

\input{santiago_da_silva_one_2018}
\input{sultana_flightplan_2021}

\input{ibanez_p4_2019}

% Intel expandable architecture: leur produit hétérogène avec Tofino + FPGA
\input{noauthor_baidu_nodate}
\input{petr_kastovsky_let_2022}

% Batch d'articles sur les générateurs de trafic
\input{patterson_computer_2017}
\input{forencich_corundum_2020}
\input{adeleke_network_2023}
\input{su_fpga-based_2022}
\input{firestone_azure_2018}
...
\input{yang_using_2022} % Juniper Networks
